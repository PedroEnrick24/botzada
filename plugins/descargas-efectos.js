...
let handler = async (m, { conn, args, __dirname, usedPrefix, command }) => {
  try {
    ...
    if (/audio/.test(mime)) {
      ...
      return conn.reply(
        m.chat,
        `🚩 Responda ao *Áudio ou Nota de Voz.*`,
        m,
        rcanal
      );
  } catch {
...
handler.command =
  /^(bass|blown|deep|earrape|fas?t|nightcore|reverse|robot|slow|smooth|tupai|squirrel|chipmunk|reverb|chorus|flanger|distortion|pitch|highpass|lowpass|underwater)$/i;
