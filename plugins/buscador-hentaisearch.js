  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(async ({ data }) => {
        ...
        result.result = res;
        result.warning =
          "It is strictly forbidden to reupload this code, copyright © 2022 by rem-comp";
